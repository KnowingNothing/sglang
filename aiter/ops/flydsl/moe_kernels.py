...
def compile_flydsl_moe_stage1(
    ...
    if a_dtype in ("bf16", "fp8") and b_dtype in ("fp4", "mxfp4"):
        ...
        return compile_mixed_moe_gemm1_a16w4(
            ...
            # gfx942 A8W4 currently uses the direct epilogue.  The inherited
            # A16W4 CShuffle path writes only one N-wave quarter for this FP8
            # operand geometry; selecting the direct path here is explicit
            # and independent of FLIR_MOE_STAGE1_CSHUFFLE.
            use_cshuffle_epilog=False if a_dtype == "fp8" else None,
        )
...
def _flydsl_moe_stage1_impl(
    ...
    *,
    ...
    dev = a.device
    _is_a16w4 = a_dtype in ("bf16", "fp8") and b_dtype in ("fp4", "mxfp4")
